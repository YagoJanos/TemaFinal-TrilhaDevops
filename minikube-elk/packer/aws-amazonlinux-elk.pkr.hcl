...
build {
  ...
  provisioner "ansible-local" {
    ...
    role_paths      = ["../ansible/roles/system_config", "../ansible/roles/docker_setup", "../ansible/roles/minikube_setup", "../ansible/roles/elasticsearch_config"]
  }
